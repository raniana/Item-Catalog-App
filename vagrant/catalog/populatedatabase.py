...
# Items of category 1
category1 = Category(user_id=1, name="Grocery")
...
category2 = Category(user_id=1, name="Baby Essentials")
...
Item3 = Item(user_id=1, name="Baby Lotion", description=" unscented rich moisturizer for sensitive skin ",
                     price="15", brand="bebees", category=category2)
